                ...
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-0 w-full lg:p-11 p-5">
                    <div className="bg-white rounded-lg p-6 block">
                      <a href="tel:+9779811111111" className="flex items-center mb-6">
                        📞 <h5 className="text-black text-base font-normal leading-6 ml-5">+977 9811111111</h5>
                      </a>
                      <a href="mailto:rohanck073@gmail.com" className="flex items-center mb-6">
                        ✉️ <h5 className="text-black text-base font-normal leading-6 ml-5">ashmita@gmail.com</h5>
                      </a>
                    </div>
                  </div>
                </div>
