      ...
      <div className="bg-white-50 min-h-screen flex flex-col relative">
        ...
        <div className="text-center lg:text-left max-w-lg z-20 lg:pr-32 lg:w-1/2 lg:ml-[-10px] lg:mt-[-80px]">
          <h1 className="text-4xl font-extrabold text-gray-900 leading-snug">
            ...
            <span className="text-blue-600">vehicle</span> Join us to keep your  in top shape.
          </h1>
          <p className="mt-4 text-gray-600">Your App For Easy Service.</p>
          <a 
          href="/login" 
        ...
        <div className="max-w-lg bg-white shadow-lg rounded-lg p-5 z-20 lg:ml-[435px] lg:w-[45%]">
          ...
          <p className="text-gray-600 mb-6">
            Get access to quality automobile services.
          </p>
...
>
  {showPassword ? <FaEyeSlash /> : <FaEye />}
      ...
      <div className="absolute w-full flex justify-start">
        <img src="/images/mechanichome.jpg" alt="Healthcare Professionals" className="w-[750px] h-[700px] max-w-full object-contain translate-x-[200px]" />
      </div>
    </div>
  </>
  );
