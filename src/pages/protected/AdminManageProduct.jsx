...
// 
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (editingProduct) {
        ...
        toast.success("✅ ProductSS added successfully!");
      }
    ...
    <div className="flex">
      ...
      <div className="flex-1 p-6 ml-64">
        <h1 className="text-3xl font-bold text-gray-800 mb-4 flex items-center">
          <FaCapsules className="mr-2" /> Manage Parts
        </h1>
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
      ...
      <h2 className="text-xl font-bold mb-4">{editingProduct ? "Edit Products" : "Add Parts"}</h2>

      <input type="text" name="name" placeholder="Parts Name" className="w-full border p-2 mb-2" onChange={handleInputChange} value={newProduct.name} />
      <input type="text" name="genericName" placeholder="Company Name" className="w-full border p-2 mb-2" onChange={handleInputChange} value={newProduct.genericName} />
