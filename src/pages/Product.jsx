...
const categories = ["All", "Battery", "Tyres","Break Pads", "Air Filter", "Oil Filter"];
const manufacturers = ["All", "Toyota", "Mercedes", "Suzuki"];
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="mr-2"
                  />
                  <label htmlFor="prescriptionOnly" className="text-sm">Confirm</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                />
                <div className="space-y-4">
                  <p className="text-gray-600"><span className="font-semibold">Type:</span> {selectedProduct.genericName}</p>
                  <p className="text-gray-600"><span className="font-semibold">Manufacturer:</span> {selectedProduct.manufacturer}</p>
                  <p className="text-gray-600"><span className="font-semibold">Quantity:</span> {selectedProduct.dosage}</p>
